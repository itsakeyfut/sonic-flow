...
pub enum AppEvent {
    ...
    PlaylistCreated { playlist_id: PlaylistId, name: String },
    
    /// Playlist was updated
    PlaylistUpdated { playlist_id: PlaylistId },
    
    /// Track added to playlist
    TrackAddedToPlaylist { playlist_id: PlaylistId, track_id: TrackId },
    
    /// Track removed from playlist
    TrackRemovedFromPlaylist { playlist_id: PlaylistId, track_id: TrackId },
